...
export class ContactanosComponent implements OnInit {
  ...
  config: Configuracion = { nombreEmpresa: 'Cargando...', ruc: '', direccion: '', telefono: '', email: '', sitioWeb: '', obligadoContabilidad: 'NO', ivaPorcentaje: 15 };
  ...
  ngOnInit(): void {
    this.api.getConfig().subscribe({
      next: (data) => {
        this.config = data;
        this.cd.detectChanges(); // <-- Forzar visualización inmediata
      },
